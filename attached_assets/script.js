...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('install-form').addEventListener('submit', function(e) {
        ...
        if (findBusByNumber(busn) !== -1) {
            showAlert('Bus with this number already exists!', 'danger');
            return;
        }
    ...
    document.getElementById('reservation-form').addEventListener('submit', function(e) {
        ...
        // Update seat with passenger name and phone
        buses[busIndex].seats[row][col] = `${passengerName} (${passengerPhone})`;
